...
- (ABButton *)buttonWithAboveLabelTitle:(NSString *)aStr belowLabelTitle:(NSString *)bStr {
    ...
    aboveL.text = aStr;
    aboveL.font = [UIFont systemFontOfSize:16.0];
//    aboveL.textColor = ABColor(21, 135, 228, 1.0);
    ...
    belowL.textColor = ABColor(164, 164, 164, 1.0);
...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        self.layer.borderColor = ABColor(164, 164, 164, 1.0).CGColor;
...
- (void)layoutSubviews {
    ...
    self.aboveL.frame = CGRectMake(0, 3, self.width, 30);
...
-(void)setSelected:(BOOL)selected{
    self.layer.borderColor = selected ? [UIColor orangeColor].CGColor : ABColor(164, 164, 164, 1.0).CGColor;
    self.aboveL.textColor = selected ? [UIColor orangeColor] : ABColor(164, 164, 164, 1.0);
    self.belowL.textColor = selected ? [UIColor orangeColor] : ABColor(164, 164, 164, 1.0);
}
