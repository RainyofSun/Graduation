...
// 这个是滑动时当前显示的index的下标, 从 0 开始  注意, 通知的字典中的键名是 currentIndex
#define ScrollPageViewDidShowThePageNotification @"ScrollPageViewDidShowThePageNotification"
//这个是点击时当前显示的index的下标,从 0 开始 注意，通知的字典中的键名是   clickTitleIndex
#define ClickPageViewDidShowThePageNotification @"ClickPageViewDidShowThePageNotification"
