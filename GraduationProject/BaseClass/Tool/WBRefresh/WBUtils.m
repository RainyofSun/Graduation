...
+ (void)addLoadMoreForScrollView:(UIScrollView *)scrollView
    ...
    WBRefreshFooter *footer = [WBRefreshFooter footerWithRefreshingBlock:^{
    ...
    footer.stateLabel.textColor = RGBCOLOR(90, 90, 90);
    footer.stateLabel.font = SETFONTSIZE(13.0);
...
+ (NSAttributedString *)attStringWithString:(NSString *)string keyWord:(NSString *)keyWord {
    return [self attStringWithString:string keyWord:keyWord font:SETFONTSIZE(16) highlightedColor:[UIColor redColor] textColor:BLACK];
}
...
//    if ([NHUserInfoManager sharedManager].isLogin == NO) {
//        return NO;
//    }
//    if (userId == 0) {
//        return NO;
//    }
//    return [NHUserInfoManager sharedManager].currentUserInfo.user_id == userId;
//}
